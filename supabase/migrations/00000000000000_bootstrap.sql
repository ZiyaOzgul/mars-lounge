...
-- ---- day_closures ("Gunu Bitir" kayitlari) -------------------------------
-- Raporlarin gun siniri. Takvim gecesi yerine bu anlar kullanilir; boylece
-- gece 02:00a kadar acik kalan dukkanin cirosu ertesi gune kaymaz.
...
CREATE INDEX IF NOT EXISTS idx_day_closures_closed_at
  ON public.day_closures (closed_at DESC);
